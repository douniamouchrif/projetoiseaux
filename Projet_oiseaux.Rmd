...
ggplot(data = resultats_df, aes(x = Année, y = Moyenne_D_2)) +
  ...
  theme_minimal()
```
On remarque que, entre 2018-2019 et 2022-2023, l'exponentielle de l'indice de Shannon diminue d'environ 0.5/1.0 en moyenne, ce qui reste très léger. Finalement, celui-ci reste assez constant au fil des années.
## chercher ce que ça signifique quand ça diminue
