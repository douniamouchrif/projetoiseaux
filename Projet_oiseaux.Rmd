...
```{r}
# Vecteur d'abondance des espèces pour le test
x <- c(0, 1, 1, 2, 5)

# Test des fonctions avec le vecteur d'abondance des espèces
proportions <- proportion(data.frame(Denombrement_min = x, Code_Maille = c('2','2','2','4','4'), Nom_Latin = c('a','b','c','d','e')))
D_2 <- exp_shannon(proportions)
D_3 <- proba_simpson(proportions)
